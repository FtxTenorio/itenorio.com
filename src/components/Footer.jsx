          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li>
                <button
                  onClick={handleHomeClick}
                  className="hover:text-[#0078d7] transition-colors bg-transparent border-none p-0 cursor-pointer"
                >
                  Home
                </button>
              </li>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/30 transition-all duration-300 group"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 hover:bg-[#0077b5]/20 hover:border-[#0077b5] transition-all duration-300 group"
              >
